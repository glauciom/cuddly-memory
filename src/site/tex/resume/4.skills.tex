...
\cventry
   {Technical Proficiency}{}{}{}
   {
	 ...
	 \cventry
	    ...
	    {
	      \begin{cvitems}
	 			 	\item \textcolor{red}{\textbf{red}}: I'm using and working now;
	 			 	\item \textcolor{green}{\textbf{green}}: I'm learning / interested to apply in the future;
	 			 	\item \textcolor{blue}{\textbf{blue}}: I would like to use again.
	       \end{cvitems}
	    }
\end{cventries}
\pagebreak
